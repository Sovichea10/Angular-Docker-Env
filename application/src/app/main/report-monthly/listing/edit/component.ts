...
export class EditDialogComponent implements OnInit{
    ...
    if(this.form.valid){
      ...
      this._service.update(this.data.id, this.form.value).subscribe( 
        ...
        (res: any) =>{ 
          ...
          this._dialogRef.close(res.customer); 
        },  
  ...
  private _buildForm() {
    ...
    this.form = new FormGroup({
      description: new FormControl(this.data.name, [ Validators.required ]),
      month: new FormControl(this.data.phone, [ Validators.required ]),
