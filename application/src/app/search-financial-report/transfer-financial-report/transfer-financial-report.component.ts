...
@Component({
    selector: 'transfer-financial-report',
    templateUrl: './transfer-financial-report.component.html',
    styleUrls: ['./transfer-financial-report.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class TransferFinancialComponent implements OnInit {
